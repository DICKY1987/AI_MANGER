...
Usage (one-line):
  Set-ExecutionPolicy -Scope Process Bypass -Force; iwr https://raw.githubusercontent.com/DICKY1987/AI_MANGER/main/scripts/Install-CliStack.ps1 -UseBasicParsing | iex
#>
[CmdletBinding()]
param(
